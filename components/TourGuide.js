    ...
    if (Platform.OS === 'web') {
      ...
      const webAdminSteps = [
        ...
        },
        {
          ...
          description: 'Click "Admin" in the navigation bar to open User Management (roles, invites) and other admin tools.',
          targetId: 'web-nav-admin',
          interaction: true,
          action: () => router.push('/admin/users'),
        },
        {
          id: 'web-admin-users-overview',
          route: '/admin/users',
          title: 'User Management',
          description: 'Invite people from your organisation, change roles (Admin vs User), and enable or disable accounts. Role changes apply to domain users listed here.',
          targetId: 'web-admin-users-tour',
          interaction: false,
        },
        {
          id: 'web-admin-qr-link-step',
          route: '/admin/users',
          title: 'QR code sheets',
          description: 'When you need printable QR labels for new assets, tap "QR sheets" to generate Excel files with IDs and QR codes.',
          targetId: 'web-admin-qr-link',
          interaction: true,
        ...
        },
        {
          ...
          description: 'This screen creates Excel sheets with unique Asset IDs and QR codes for labelling physical assets.',
        ...
        },
        {
          ...
          description: 'Enter the number of QR codes you want (up to 2000) and click "Generate Excel" to create a spreadsheet with Asset IDs and QR code images.',
        ...
        },
        {
          ...
          description: 'After generating, click "Download Excel" to get your sheet. You can refresh the list to see all generated files on the server.',
