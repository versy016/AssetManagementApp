...
const styles = StyleSheet.create({
  ...
  equipmentAddText: { fontSize: 12, fontWeight: '600', color: Colors.primary },
  equipmentAddTextHighlighted: { color: Colors.primaryDark, fontWeight: '700' },
  ...
  equipmentRemoveText: { fontSize: 11, fontWeight: '600', color: '#B91C1C' },
  exportBtn: {
    marginTop: 12,
  ...
  exportBtnSecondaryText: { fontSize: 15, fontWeight: '700', color: Colors.primary },
  exportBtnShare: {
    marginTop: 12,
  ...
  exportBtnShareDisabledDs: { backgroundColor: '#64748B' },
  exportBtnSecondaryDisabled: { borderColor: '#94A3B8', opacity: 0.75 },
  sendBtnInner: { alignItems: 'center', gap: 3 },
  sendBtnNote: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '500' },
  sendBtnNote2: { fontSize: 11, color: Colors.sub, fontWeight: '500', marginTop: 2 },
