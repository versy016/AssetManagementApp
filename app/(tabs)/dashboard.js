      ...
      <View style={styles.dashboard}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {showProfileMenu && (
            <View style={styles.profileMenu}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  setShowProfileMenu(false);
                  // Profile page (read-only email, edit name, reset password)
                  router.push('/profile');
                }}
              >
          ...
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity style={styles.actionButton} onPress={() => router.push('/qr-scanner?mode=multi')}>
            ...
            <TouchableOpacity style={styles.actionButton} onPress={() => router.push('/asset/assets')}>
...
const styles = StyleSheet.create({
  ...
  dashboard: { flex: 1, backgroundColor: '#f5f5f5' },
  scrollContent: { padding: 20, paddingBottom: 40 },
  loadingContainer: { justifyContent: 'center', alignItems: 'center', flex: 1 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  greetingText: { fontSize: 18, color: '#333', fontWeight: '500' },
  avatar: {
    backgroundColor: '#1E90FF', borderRadius: 25, width: 50, height: 50, justifyContent: 'center', alignItems: 'center', elevation: 2,
  },
  ...
  welcomeText: { fontSize: 22, fontWeight: 'bold', color: '#333', marginBottom: 25 },
  quickActions: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginBottom: 25 },
  actionButton: {
    backgroundColor: '#fff', padding: 18, borderRadius: 12, width: '48%', alignItems: 'center', marginBottom: 15,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 2,
  },
  actionText: { color: '#1E90FF', marginTop: 8, fontSize: 15, fontWeight: '500' },
  shortcutsSection: { marginBottom: 25 },
  sectionTitle: { fontSize: 14, fontWeight: 'bold', color: '#666', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 },
